...
### Text
What is the <i>next best step</i> in management if you have a
<b>positive</b> <font color="#FC0280">ectocervix</font>
<b>finding</b> and <u>negative endocervix finding</u> upon
colposcopy?
<div>
  {{c1::Local destruction (LEEP/Cryoablation)}}
</div>

### Extra
<div>
  <i>- Only on outside, so can destroy (vs. cone biopsy for
  endo)</i>
</div>
<div>
  <div>
    <i>- Positive curettage findings: cone biopsy</i>
  </div>
  <div>
    <i>- Positive biopsy findings: local ablation therapy
    (cryotherapy or LEEP)</i>
  </div>
</div><i><img src="paste-8525510083262.jpg"></i>
