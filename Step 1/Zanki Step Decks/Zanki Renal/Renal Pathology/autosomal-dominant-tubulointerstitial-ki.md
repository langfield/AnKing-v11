...
<div>
  <div>
    <b>Autosomal Dominant Tubulointerstitial Kidney Disease
    (ADTKD)</b> has the <i>potential</i> to present with cysts in
    the {{c1::medullary collecting ducts}}
  </div>
</div>

### Extra
Used to be called <i style="font-weight: bold;">Medullary cystic
kidney disease</i><i>; misnomer because most patients <u>do not</u>
have cysts</i>
