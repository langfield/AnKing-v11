...
### Text
<div>
  Vagal stimulation <i>increases</i> <b>H<sup>+</sup> secretion</b>
  <u>directly</u> via binding of <b>{{c2::acetylcholine}}</b> to
  <b>{{c1::M<sub>3</sub>}} receptors</b> on parietal cells
</div>

### Extra
<div>
  <i>this direct pathway is blocked with anti-muscarinics</i>
</div>
