...
### Text
<div>
  The <b>increase</b> in <b>{{c2::cardiac output}}</b> due to
  thyroid hormone is the result of a combination of
  <i>increased</i> <b>heart rate</b> and <i>increased</i> <b>stroke
  volume (contractility)</b>
</div>
