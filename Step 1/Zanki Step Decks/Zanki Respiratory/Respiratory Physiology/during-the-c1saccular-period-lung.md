...
### Text
<div>
  During the <b>{{c1::<font color="#AA0000">s</font>accular}}
  period</b> (lung development), the <b>{{c2::alveolar ducts}}</b>
  form the <b>{{c3::terminal sacs}}</b>
</div>
...
<div>
  ...
  <div>
    <i><img src="Messages%20Image(1680969394).jpeg" draggable=
    "false"></i>
  </div>
