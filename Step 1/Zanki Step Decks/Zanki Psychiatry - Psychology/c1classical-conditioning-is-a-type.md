...
### Text
<div>
  {{c1::Classical conditioning}} is a type of conditioning where a
  <u>natural response</u>is elicited by a <b>conditioned/learned
  stimulus</b> that was <i>previously</i> presented with an
  <b>unconditioned stimulus</b>
</div>

### Extra
<div>
  <i>e.g. Pavlov's dog:</i>
</div>
<div>
  <i>unconditioned stimulus = food</i>
</div>
<div>
  <i>conditioned stimulus = bell</i>
</div>
<div>
  <i>natural response = salivation</i>
</div>
