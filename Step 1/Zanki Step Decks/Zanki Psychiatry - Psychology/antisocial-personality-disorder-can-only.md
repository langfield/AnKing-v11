...
<div>
  <div>
    <b>Antisocial personality disorder</b> can only be diagnosed if
    the patient is <b>{{c1::<u>></u> 18}} years old</b> and has
    a <b>history of conduct disorder before age {{c2::15}}</b>
  </div>
</div>

### Extra
<i>conduct disorder if < 18 years old</i>
