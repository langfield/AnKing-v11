...
### Text
<div>
  <b>Hyperopia</b> is corrected with {{c1::<u>biconvex</u>
  (converging)}} <b>lenses</b>
</div>

### Extra
<div>
  <div>
    Biconvex (positive) lens <b>converges</b> the light earlier so
    that when cornea focuses the light it brings focal point
    <u>forward</u> to the retina (less dispersed light that hits
    the retina will converge earlier)
  </div>
</div>
<div><img src="paste-44989782425601%20(1).jpg"></div>
