...
### Text
<div>
  <b>Myopia</b> is corrected with {{c1::<u>biconcave</u>
  (diverging)}} <b>lenses</b>
</div>

### Extra
<div>
  In myopia, the problem is the focal point occurs <b>in front</b>
  of the retina
</div><img src="paste-48215302864897.jpg">
<div>
  This type of lens <b>diverges</b> the light so that when cornea
  focuses the light, it moves the focal point <b>back</b> (light
  will converge further back)
</div>
