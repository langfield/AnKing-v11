...
### Text
<div>
  At the <b>{{c2::optic chiasm}}</b>, 60% of the optic fibers from
  the <u>{{c1::nasal}} half</u> of each retina <i>cross</i> and
  project into the contralateral <b>{{c3::optic tracts}}</b>
</div>

### Extra
<div>
  <i>thus it is the <u>temporal</u> image that decussates</i>
</div>
