...
### Text
<div>
  Visual information from the <u>{{c3::inferior}} retina</u>
  travels in {{c1::<b>Meyer's loop</b> (temporal lobe)}} before
  synapsing in the <b>{{c2::lingual}} gyrus</b>
</div>

### Extra
<div>
  <i>i.e. images from the <u>upper</u> contralateral visual field;
  travels around inferior horn of lateral ventricle</i>
</div>
<div>
  <i><img src="paste-222152888418872.jpg"></i>
</div>
