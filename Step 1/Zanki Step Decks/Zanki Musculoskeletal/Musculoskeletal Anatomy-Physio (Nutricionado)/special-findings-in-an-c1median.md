...
### Text
Special findings in a(n) {{c1::<b>median</b>}} nerve injury include
"{{c1::Median}} Claw" ({{c3::<i>distal lesion</i>}}) and
"{{c2::Pope's blessing}}" ({{c3::<i>proximal lesion</i>}})

### Extra
<div><img src="paste-52836687675393.jpg" class="resizer"></div>
