...
### Text
<div>
  The <b>Kussmaul sign</b> (increased JVP on inspiration) occurs
  due to <i>failure</i> of <u>negative intrathoracic pressure</u>
  to be transmitted to the {{c1::heart}} during inspiration
</div>

### Extra
<i>- normally inspiration leads to increased VR, leading to a
slight fall in mean JVP</i>
<div>
  <i>- Because negative intrathoracic pressure is not transmitted
  to the heart,</i> <i>as a result, blood backs up in the vena
  cavae</i>
</div>
<div>
  - This occurs when there are situations that impair heart filling
</div>
