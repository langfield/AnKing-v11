...
### Text
<div>
  <span style="color: var(--text-fg);"><b>Sodium intake</b>,
  <b>o</b></span><span style="color: var(--text-fg);"><b>besity</b>
  (sedentary lifestyle), and <b>a</b></span><span style=
  "color: var(--text-fg);"><b>lcohol</b> <b>intake</b></span>
  <span style="color: var(--text-fg);">are</span> <u style=
  "color: var(--text-fg);">modifiable</u> <span style=
  "color: var(--text-fg);">risk factors</span> <span style=
  "color: var(--text-fg);">for</span> <span style=
  "color: var(--text-fg);">primary</span> <span style=
  "color: var(--text-fg);">{{c1::hypertension}}</span>
</div>
...
### Sketchy
<img src="SketchyMedical%202019-12-22%2010-32-40.jpg"><img src=
