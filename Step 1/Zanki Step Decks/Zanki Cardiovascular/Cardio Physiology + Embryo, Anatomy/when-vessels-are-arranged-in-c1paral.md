...
### Text
<div>
  When vessels are arranged in <b>{{c1::parallel}}</b>, the
  <i>total</i> resistance is <u>less</u> than the resistance of any
  of the <i>individual</i> arteries
</div>

### Extra
<i>via 1/R<sub>total</sub> = 1/R<sub>1</sub> + 1/R<sub>2</sub>
...</i>
