...
### Text
<div>
  When resistances are arranged in <b>{{c1::series}}</b>, the total
  <b>{{c2::flow}}</b> through each level of the system is the
  <b>same</b>
</div>

### Extra
<i>however, <u>pressure</u> decreases throughout the series</i>
