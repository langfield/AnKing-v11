...
### Text
<b>P-glycoprotein</b> is encoded for by the {{c1::MDR1 gene}}

### Extra
<div>
  - This is an efflux pump normally used by gut and kidney to pump
  out toxins, tumors can use these to pump out chemotherapeutics
</div>- In contrast, the MDR2 gene encodes for another efflux pump
that the liver uses to excrete conjugated bilirubin / kidney uses
to excrete toxins (<u>defective in Dubin-Johnson syndrome</u>)
