...
### Text
<div>
  <b>{{c1::Protoporphyrin}}</b> and {{c2::<b>Fe</b><sup style=
  "font-weight: bold;">2+</sup>}} combine to form
  <b>{{c3::heme}}</b> via the enzyme <b style=
  "font-style: italic;">{{c4::ferrochelatase}}</b>
</div>
