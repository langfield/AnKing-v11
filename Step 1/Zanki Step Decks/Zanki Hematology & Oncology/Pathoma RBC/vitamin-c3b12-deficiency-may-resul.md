...
<div>
  <div>
    <div>
      <div>
        <div>
          <b>Vitamin {{c3::B<sub>12</sub>}}</b> <u>deficiency</u>
          may result in <i>poor</i> <b>{{c1::proprioception}}</b>
          and <b>{{c2::vibratory}}</b> <b>sense</b> due to damage
          to the <b>dorsal (posterior) column</b> of the spinal
          cord
        </div>
      </div>
    </div>
