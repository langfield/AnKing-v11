...
### Text
<div>
  If the developing embryo <b>splits</b> in the <b>morula stage</b>
  (4-8 days), the twins will be {{c1::mono::mono/di}}-chorionic and
  {{c1::di::mono/di}}-amniotic
</div>

### Extra
<div>
  - S<b>C</b>AB = 4-8 days: shared <b>C</b>horion
</div>
<div>
  - 75% of cases, this is through the existence of the blastocyst
  (early embryoblast) and embryoblast (inner cell mass) +
  trophoblast (outer cell mass)
</div>
<div><img src="paste-261619342901422.jpg"></div>
