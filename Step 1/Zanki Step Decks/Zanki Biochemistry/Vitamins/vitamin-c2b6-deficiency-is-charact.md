  ...
  <div>
    <div>
      <div>
        ...
        "font-weight: bold;">6</sub>}} <u>deficiency</u> is
        characterized by <b>{{c1::sideroblastic}} anemia</b> and
        <b>{{c3::peripheral neuropathy}}</b>
      </div>
    </div>
  </div>
</div>
...
### Extra
<i>sideroblastic anemia due to impaired hemoglobin synthesis and
iron excess; other symptoms include convulsions, hyperirritability,
and cheilosis/stomatitis</i>
