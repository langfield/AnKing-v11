...
<div>
  <div>
    <b>{{c1::Essential fructosuria}}</b> is characterized by a
    <u>defect</u> in the <b>{{c2::fructokinase}}</b> enzyme
  </div>
</div>

### Extra
As a result, Hexokinase becomes the primary pathway for converting fructose to F6P
