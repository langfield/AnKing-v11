...
### Text
<div>
  <i style="font-weight: bold;">{{c1::Glycogen phosphorylase}}</i>
  liberates <b>{{c2::glucose-1-phosphate}}</b> residues off
  branched glycogen until 4 glucose units remain on a branch
</div>
