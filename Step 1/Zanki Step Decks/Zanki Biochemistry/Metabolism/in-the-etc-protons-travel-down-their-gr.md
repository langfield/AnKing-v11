...
### Text
<div>
  In the <u>ETC</u>, <b>protons</b> travel down their gradient
  through the {{c1::<b>F<sub>0</sub>/F<sub>1</sub> ATP
  Synthase</b>}} <b>pump</b>, generating <b>{{c2::ATP}}</b> and
  <b>{{c2::heat}}</b>
</div>

### Extra
<b>Complex V</b>=ATP Synthase
