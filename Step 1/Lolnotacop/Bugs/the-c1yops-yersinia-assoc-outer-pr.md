...
### Text
The <b>{{c1::YOPS</b> (<i>Yersinia</i> assoc. outer
proteins)<b>}}</b> are secreted via a(n) <u>{{c2::type III}}
secretion system</u> in <i>Yersinia</i> {{c3::<i>spp.</i>}}

### Extra
<div>
  <i>YOPS cause macrophage/neutrophil dysfunction by inhibiting
  phagocytosis and cytokine production</i>
</div>
<div><img src="paste-57088705298915.jpg"></div>
