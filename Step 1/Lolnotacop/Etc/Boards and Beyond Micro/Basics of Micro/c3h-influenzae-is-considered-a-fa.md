...
### Text
{{c3::<i>H. influenzae</i>}} is considered a <u>fastidious
bacteria</u> because it needs <b>{{c1::NAD+ (factor V)}}</b> and
<b>{{c2::hematin (factor X)}}</b> to grow

### Extra
both obtained from lysed RBCs of <b><u>Chocolate Agar</u></b>
<div>
  recall that fastidious = needs particular nutrients in order to
  grow
</div>
