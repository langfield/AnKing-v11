...
### Text
<b>{{c2::Chocolate}} Agar</b> contains <u>{{c1::NAD+}} (factor
{{c1::V}})</u> and <u>{{c1::hematin}} (factor {{c1::X}})</u> which
are release when the RBCs are lysed

### Extra
heating of blood agar lyses the RBCs, releasing these factors - allows growth of H. flu (fastidious bacteria that requires these factors)
