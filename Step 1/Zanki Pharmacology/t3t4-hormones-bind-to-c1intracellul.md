...
### Text
T3/T4 hormones bind to {{c1::intracellular::cellular location}}  receptors

### Extra
<img src="Screen%20Shot%202017-05-01%20at%203.58.08%20PM.png">
<div>
  Binds with intracellular receptors that control gene expression
  (increase Na/K-ATPase, B1 receptors, etc.)
</div>
