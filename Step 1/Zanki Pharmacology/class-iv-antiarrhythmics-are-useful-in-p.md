...
### Text
<div>
  <b>Class IV antiarrhythmics</b> are useful in preventing
  {{c1::rapid ventricular response (RVR)}} in atrial fibrillation
  and flutter ("<b>rate control</b>")
</div>

### Extra
RVR is Afib passing to the ventricles
