...
<div>
  <div>
    <b>Imatinib</b> can inhibit the receptor tyrosine kinase
    <b>{{c1::c-Kit}}</b>, making it useful for <b>GI</b>
    <b>{{c2::Stromal Tumors (GIST)}}</b>
  </div>
</div>

### Extra
<div>
  <i>-c-Kit is the receptor for SCF (stem cell factor), thus can be
  used in diseases with proliferation of cells that express this
  receptor (ex systemic mastocytosis)</i>
</div>
<div>
  <i><b>FA 2019</b>: now also lists <b>dasatinib</b></i>
</div>
<div>
  <i><img src="paste-65038689763329.jpg" class="resizer"></i>
</div>
